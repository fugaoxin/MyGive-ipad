...
- (id)initWithHeaderTitle:(NSString *)headerTitle content:(NSString *)content
        cancelButtonTitle:(NSString *)cancelButtonTitle
       confirmButtonTitle:(NSString *)confirmButtonTitle;


- (id)initWithHeaderTitle:(NSString *)headerTitle
        singleButtonTitle:(NSString *)singleButtonTitle singleTapAction:(void (^)()) action;
...
//
@property (nonatomic, copy) void (^leftTapAction)();

@property (nonatomic, copy) void (^rightTapAction)();
