...
(function ($, window, document) {
    ...
    EmojiArea.prototype.setup = function () {
        ...
        this.$editor.on('blur', function () { self.hasFocus = false; self.selection = util.saveSelection(); }); // modified Tree.Yip 20151008
    ...
    */
    ...
    EmojiMenu.prototype.onItemSelected = function (emoji) {console.log('onItemSelected');
        console.log(this.$editor);
        document.getElementById('emoji-wysiwyg-editor').focus();
