...
@interface EGScrollView ()<UIScrollViewDelegate>
{
    NSTimer *_myTimer;
...
-(void)refreshUI
{
    ...
    _preImageView.contentMode = UIViewContentModeScaleAspectFill;        // 设置图片正常填充
    ...
    _lastImageView.contentMode = UIViewContentModeScaleAspectFill;        // 设置图片正常填充
